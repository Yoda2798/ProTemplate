...
import YodasMod.cards.Defend;
import YodasMod.cards.Strike;
import YodasMod.relics.TodoItem;

import java.util.ArrayList;

import static YodasMod.YodaCharacter.Enums.YODASMOD_COLOR;
import static YodasMod.YodasMod.*;

public class YodaCharacter extends CustomPlayer {
    ...
    public YodaCharacter(String name, PlayerClass setClass) {
    ...
    public AbstractPlayer newInstance() {
        return new YodaCharacter(name, chosenClass);
    }
    ...
    public static class Enums {
        //TODO: Change these.
        @SpireEnum
        public static AbstractPlayer.PlayerClass YODA_CHARACTER;
        @SpireEnum(name = "YODASMOD_COLOR")
        public static AbstractCard.CardColor YODASMOD_COLOR;
        @SpireEnum(name = "YODASMOD_COLOR")
