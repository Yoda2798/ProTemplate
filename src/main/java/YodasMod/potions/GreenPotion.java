...
public class GreenPotion extends AbstractEasyPotion {
    public static final String POTION_ID = makeID("GreenPotion");
    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    public static final String NAME = potionStrings.NAME;
    public static final String[] DESCRIPTIONS = potionStrings.DESCRIPTIONS;

    public static final Color liquidColor = CardHelper.getColor(19, 200, 20);
    ...
    private static CardGroup greenCards = new CardGroup(CardGroup.CardGroupType.UNSPECIFIED);
    ...
    public void use(AbstractCreature target) {
        this.addToBot(new CustomDiscoveryAction(greenCards, 3, potency, true));
    }
