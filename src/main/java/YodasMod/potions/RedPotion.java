...
public class RedPotion extends AbstractEasyPotion {
    public static final String POTION_ID = makeID("RedPotion");
    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);
    public static final String NAME = potionStrings.NAME;
    public static final String[] DESCRIPTIONS = potionStrings.DESCRIPTIONS;

    public static final Color liquidColor = CardHelper.getColor(219, 10, 20);
    ...
    private static CardGroup redCards = new CardGroup(CardGroup.CardGroupType.UNSPECIFIED);
    ...
    public void use(AbstractCreature target) {
        this.addToBot(new CustomDiscoveryAction(redCards, 3, potency, true));
    }
